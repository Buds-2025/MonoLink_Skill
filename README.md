...
This repository contains the packaged `monolink-skil.zip` Codex skill.
...
- `agents/openai.yaml`: Codex UI metadata and the default `$monolink-skil` invocation prompt.
...
Install by extracting `monolink-skil.zip` into your Codex skills directory.
